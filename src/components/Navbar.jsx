          ...
          isSticky ? "sticky top-0 right-0 left-0 border bg-white transition-all duration-300" : ""
             ...
             <div className='flex justify-between items-center text-base gap-8'>
                <a href="" className='text-2xl font-semibold flex items-center space-x-3'>
                    ...
                    <span className='text-[#263238]'>ATOM SAS</span></a>
                    ...
                    <div className="space-x-12 hidden lg:flex items-center">
                        ...
                        <button className="bg-brandPrimary text-white py-2 px-4 trasition-all duration-300 rounded hover:bg-neutralDgray">Sign Up</button>
              ...
              <div className={`space-y-4 px-4 mt-16 py-7 bg-brandPrimary ${isMenuOpen ? "block fixed top-0 right-0 left-0" :"hidden" }`}>
              {
                      ...
                      to={path} spy={true} smooth={true} offset={-100} 
                      key={link} href={path} 
